...
Aether is pre-1.0 alpha software. Only the latest released version is
...
Use GitHub's [private vulnerability reporting](https://github.com/MortisDei/aether/security/advisories/new)
...
In scope: the Aether application itself (`src/`), its build and packaging
scripts, and its CI workflows.

Out of scope: vulnerabilities in third-party runtimes Aether manages but does
