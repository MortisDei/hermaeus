...
public sealed class MigrationRunnerTests
{
    ...
    public async Task Applies_migrations_in_order_and_records_version()
    {
        ...
        await using var cmd = c.CreateCommand();
        cmd.CommandText = "SELECT version FROM aether_schema_versions WHERE scope = 'test_scope'";
    ...
    public async Task Version_scopes_are_independent()
    {
        ...
        cmd2.CommandText = "SELECT version FROM aether_schema_versions WHERE scope = 'scope_a'";
