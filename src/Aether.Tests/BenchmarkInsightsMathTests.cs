...
public sealed class BenchmarkInsightsMathTests
{
    private static BenchmarkRun BuildRun(
        ...
        int caseCount, double quality, double tokensPerSecond, DateTime startedAt, string aetherVersion = "0.10.0.0")
    {
        ...
        return new BenchmarkRun
        {
            ...
            ModelName = modelName,
            StartedAt = startedAt,
            Metadata = new BenchmarkRunMetadata { Quantization = quantization, RuntimeKind = runtimeKind, AetherVersion = aetherVersion },
            Results = results
        };
    }
