...
internal static class LocalAiSetupConstants
{
    ...
    internal const string LlamaCppReleasesUrl = "https://github.com/ggml-org/llama.cpp/releases";
    internal static readonly string[] XttsPackages = ["TTS", "fastapi", "uvicorn", "soundfile"];
    internal static readonly string[] KokoroPackages = ["kokoro", "soundfile", "numpy"];
}
