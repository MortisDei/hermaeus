...
internal static class KokoroUserLexicon
{
    ...
    [
        // "aether" is a real English word CMUdict may still miss; kept
        // alongside the product name pronunciation below (r20 rename).
        ("aether", "ˈiθɚ"),
        ("hermaeus", "hɚˈmiəs"),
        ("ollama", "oʊˈlɑmə"),
        ("kokoro", "koʊˈkoʊɹoʊ"),
    ...
    private static void WriteDefaults(string path)
    {
        try
        {
            ...
            sb.AppendLine("# Hermaeus pronunciation lexicon.");
