...
/// been using Aether as their AI substrate. The caller-supplied
/// <c>X-Aether-Client</c> header is still recorded alongside it as an
...
public static class LocalApiEndpoints
{
    ...
    /// unverified <c>X-Aether-Client</c> header, kept only for display
