...
/// <summary>
/// Fields tracked across app runs so Doctor can report "Hermaeus did not shut
...
/// Lives in Hermaeus.Core (rather than Hermaeus.Services, alongside the concrete
/// <c>SettingsService</c>) so the two other ONNX Runtime consumers,
/// Hermaeus.Rag and Hermaeus.Voice, can both use it without a reference against
