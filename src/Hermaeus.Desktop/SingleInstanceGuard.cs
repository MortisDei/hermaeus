...
/// <summary>
/// Prevents two Hermaeus processes for the same OS user account from running
...
internal static class SingleInstanceGuard
{
    ...
    internal static string DefaultLockFilePath => Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Hermaeus", "hermaeus.lock");
