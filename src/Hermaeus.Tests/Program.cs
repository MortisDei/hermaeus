...
internal static class AgentTests
{
    ...
    await File.WriteAllTextAsync(Path.Combine(workspace, "Hermaeus.Sample.sln"), "");
    ...
    True(File.Exists(Path.Combine(workspace, ".hermaeus", "workspace.json")), "manifest should be written in-repo under .hermaeus/");
