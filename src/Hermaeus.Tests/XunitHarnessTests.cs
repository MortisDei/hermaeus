...
public static class HarnessCases
{
    ...
    [
        ...
        [new HarnessCase("Doctor embedding install keeps existing Nomic until verified Qwen is ready", ServiceTests.DoctorEmbeddingInstallKeepsExistingNomicUntilVerifiedQwenIsReady)],
        ...
        [new HarnessCase("icon-only controls have tooltips", ServiceTests.IconOnlyControlsHaveTooltips)],
        [new HarnessCase("release notes extracts an existing middle section", ReleaseNotesExtractionTests.ReleaseNotesExtractsAnExistingMiddleSection)],
        [new HarnessCase("release notes fails clearly for a missing section", ReleaseNotesExtractionTests.ReleaseNotesFailsClearlyForAMissingSection)],
        [new HarnessCase("release notes extracts the latest section at the top of the file", ReleaseNotesExtractionTests.ReleaseNotesExtractsTheLatestSectionAtTheTopOfTheFile)],
        [new HarnessCase("release notes fails for a version archived away out of the changelog", ReleaseNotesExtractionTests.ReleaseNotesFailsForAVersionArchivedAwayOutOfTheChangelog)],
        ...
        [new HarnessCase("embedding client uses known Qwen and legacy Nomic dimensions", ServiceTests.EmbeddingClientUsesKnownQwenAndLegacyNomicDimensions)],
